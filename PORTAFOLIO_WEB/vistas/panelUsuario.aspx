...
<body>
    <div class="wrap">
        ...
        <div style="height: 543px">
            ...
            &nbsp;
            <asp:Button ID="btnProductores" runat="server" Text="Productores" OnClick="Button2_Click" />
            &nbsp;
            <asp:Button ID="btnProductos" runat="server" Text="Productos" OnClick="Button3_Click" />
            &nbsp;
            <asp:Button ID="btnCarrito" runat="server" Text="Carrito de Compras" OnClick="Button4_Click" />
            &nbsp;
            <asp:Button ID="btnHistorial" runat="server" Text="Historial de Compras" OnClick="Button5_Click" />
            &nbsp;
