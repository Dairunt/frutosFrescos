<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="eliminarUsuario.aspx.cs" Inherits="PORTAFOLIO_WEB.vistas.eliminarUsuario" %>
...
<body>
    <form id="form1" runat="server">
        <h1 style="height: 5px">ELIMINAR USUARIO</h1>
    <div>
